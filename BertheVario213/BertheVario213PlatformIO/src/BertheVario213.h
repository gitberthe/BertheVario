...
// upload_url = http://10.186.74.237
// http://10.45.111.186/update
...
#define SIMUVOL_STACK_SIZE   3200
...
/*
// scan des boutons, priorite haute non interruptible
#define SCAN_BUTTON_NUM_TASK    6
