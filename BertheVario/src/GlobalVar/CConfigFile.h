...
public :
    ...
    int   m_vitesse_igc_kmh = 20 ;          ///< vitesse de declenchement enregistrement
    int   m_temps_igc_sec = 10 ;            ///< nombre de secondes de vitesse pour declenchement
    int   m_dispersion_igc_metres = 300 ;    ///< dispersion des points igc en metres
    float m_vz_igc_ms = 0.65 ;               ///< vz de vitesse pour declenchement
