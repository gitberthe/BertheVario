...
#ifdef TEST_SOUND
void TestSound(void *param)
{
while( true )
    {
    g_GlobalVar.beeper(1000,10) ;
    g_GlobalVar.beeper( SOUND_DELAY_ONLY , 10 ) ;
    }
...
#ifdef TEST_SOUND
 xTaskCreatePinnedToCore(TestSound, "Testsound", SERIAL_GPS_STACK_SIZE, NULL, SERIAL_GPS_PRIORITY,NULL, 0 );
 xTaskCreatePinnedToCore(TestSound, "Testsound", SERIAL_GPS_STACK_SIZE, NULL, SERIAL_GPS_PRIORITY,NULL, 0 );
 xTaskCreatePinnedToCore(TestSound, "Testsound", SERIAL_GPS_STACK_SIZE, NULL, SERIAL_GPS_PRIORITY,NULL, 1 );
 xTaskCreatePinnedToCore(TestSound, "Testsound", SERIAL_GPS_STACK_SIZE, NULL, SERIAL_GPS_PRIORITY,NULL, 1 );
#endif
...
Serial.println( "loop" ) ;
/*Serial.print( "TacheAttentVol:" ) ;
Serial.println( g_GlobalVar.IsRunning( ATTENTE_VOL_NUM_TASK ) ) ;
Serial.print( "TacheIgc:" ) ;
Serial.println( g_GlobalVar.IsRunning( IGC_NUM_TASK ) ) ;
Serial.print( "TachePerfMon:" ) ;
Serial.println( g_GlobalVar.IsRunning( PERF_MON_NUM_TASK ) ) ;
Serial.print( "TacheRelanceAttenteVol:" ) ;
Serial.println( g_GlobalVar.IsRunning( RELANCE_IGC_NUM_TASK ) ) ;*/
