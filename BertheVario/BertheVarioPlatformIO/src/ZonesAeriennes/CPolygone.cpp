...
bool CPolygone::IsIn( const CZoneAer::st_coord_poly * PtsArr , int NbPts , const CZoneAer::st_coord_poly & PtsToTest )
{
/*
...
int NbInter = 0 ;
// un point tres loin
static const CZoneAer::st_coord_poly ptLoin = { 0. , 0. } ;
...
/// \return true si points dans polygone
bool CPolygone::IsInOld( const CZoneAer::st_coord_poly * PtsArr , int NbPts , const CZoneAer::st_coord_poly & PtsToTest )
{
//Serial.print( "nb pts:" ) ;
...
void CPolygone::CalcBarycentre( const CZoneAer::st_coord_poly * PtsArr , int NbPts , CZoneAer::st_coord_poly & PtsBarycentre )
{
...
float CPolygone::GetAreaSize( const CZoneAer::st_coord_poly * PtsArr , int NbPts , const CZoneAer::st_coord_poly & PtsBarycentre )
{
